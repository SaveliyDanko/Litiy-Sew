...
export const AboutHeader = ({toggleSideMenu, toggleContactsMenu}) => {
    return (
        <div className={'absolute w-full h-16 flex justify-between text-black max-lg:hidden'}>
            ...
            <SvgMenu className={'w-16 h-16 fill-black mr-4 cursor-pointer'} onClick={toggleSideMenu}/>
        </div>
    )
}